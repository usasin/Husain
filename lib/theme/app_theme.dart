...
class AppColors {
  // Build 48 garde la palette sombre historique pour préserver la compatibilité
  // de tous les écrans existants qui utilisent ces valeurs dans des const.
  static const bool isLight = false;
  static const overlayBase = Colors.white;
  static const ringNeutral = Colors.white24;
